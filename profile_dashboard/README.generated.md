...
|---|---|---|---:|---|---|
| [Laptop_Price_Predictor_Using_ML](https://github.com/Md786Rizwan/Laptop_Price_Predictor_Using_ML) | mvp | high | 9/10 | Target metric: RMSE ↓ (add latest value) | Add model comparison (Linear vs RF/XGBoost) |
| [Phising_Site](https://github.com/Md786Rizwan/Phising_Site) | mvp | high | 9/10 | Target metric: F1-score ↑ (add latest value) | Add precision-recall analysis + threshold tuning |
| [Kidney_Disease_Classification_Project](https://github.com/Md786Rizwan/Kidney_Disease_Classification_Project) | mvp | high | 9/10 | Target metric: Recall ↑ (add latest value) | Add explainability report (feature importance) |
| [Exploratory-data-Analysis](https://github.com/Md786Rizwan/Exploratory-data-Analysis) | poc | medium | 7/10 | Target metric: Insight-to-action cycle time ↓ | Convert notebooks to reusable EDA report template |
| [Educational-chatbot](https://github.com/Md786Rizwan/Educational-chatbot) | poc | medium | 7/10 | Target metric: Helpful response rate ↑ | Add evaluation set and response quality rubric |
